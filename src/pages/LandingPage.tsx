  ...
  const testimonials = [
    {
      ...
      role: 'MBBS Phase 3 Part 2',
      institution: 'Bangalore Medical College & Research Institute, Bengaluru',
      content: 'This is one of the most meaningful and practical use cases of AI in medicine. The app makes cardiovascular risk prediction simple, usable and clinically relevant. With proper validation and ongoing real-world data feedback, it can scale responsibly. I genuinely believe this has the potential to become a mainstream preventive cardiology tool.',
      avatar: 'RD',
      rating: 5,
    },
    {
      ...
      institution: 'Bangalore Medical College and Research Institute, Bengaluru',
      content: 'After using the AI-assisted cardiovascular risk assessment score, I found it remarkably accurate and insightful. Its modern, data-driven approach outperforms outdated tools like the ASCVD score. The LLM-integrated chatbot makes it patient-friendly, and as a future doctor, I\'d confidently use it to guide personalized prevention and treatment decisions.',
      avatar: 'PB',
      rating: 5,
    },
  ];
  ...
  const features = [
    {
      ...
      description: 'Advanced machine learning trained on verified medical datasets with 98.5% accuracy.',
      gradient: 'from-teal-500/20 to-cyan-500/20',
    },
    {
      icon: Shield,
      title: 'Privacy First',
      description: 'Your data stays private. No storage. Local compute option available for sensitive information.',
      gradient: 'from-emerald-500/20 to-teal-500/20',
    },
    {
      icon: Activity,
      title: 'Real-Time Analysis',
      description: 'Instant risk assessment with explainable AI insights and personalized recommendations.',
      gradient: 'from-cyan-500/20 to-blue-500/20',
    },
    {
      icon: Heart,
      title: 'Holistic Care',
      description: 'Combines modern cardiology with traditional wellness practices for comprehensive health.',
        ...
        <div className="container mx-auto max-w-7xl relative z-10 px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Advanced cardiac risk prediction powered by artificial intelligence.
              ...
              >
                ...
                >
                  ...
                  <span className="font-medium text-foreground">HIPAA-aware</span>
                </motion.div>
                <motion.div 
                  className="flex items-center gap-2 px-4 py-2.5 rounded-full glass dark:glass-dark border border-teal-500/20"
                  whileHover={{ scale: 1.05, borderColor: 'rgba(20, 184, 166, 0.4)' }}
                ...
                >
                  ...
                  <span className="font-medium text-foreground">Instant results</span>
                </motion.div>
              </motion.div>
            </motion.div>
      ...
      <section className="py-20 px-4 bg-muted/30 dark:bg-white/5">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: '01', title: 'Enter Health Data', icon: Activity, desc: 'Input your medical parameters securely' },
              { step: '02', title: 'AI Analysis', icon: Brain, desc: 'Our AI processes your data instantly' },
              { step: '03', title: 'Get Results', icon: Heart, desc: 'Receive personalized risk assessment' },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 px-4 relative">
        <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold">What future doctors are saying</h2>
      ...
      <section className="py-24 px-4 relative">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              From basic assessments to advanced clinical tools — find the plan that fits your needs
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            >
              <Card className="glass dark:glass-dark border-teal-500/20 h-full shadow-xl hover:shadow-2xl hover:shadow-teal-500/20 transition-all duration-500 relative overflow-hidden group">
                {/* Hover gradient */}
                <motion.div 
                  className="absolute inset-0 bg-gradient-to-br from-teal-500/5 to-emerald-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                />
                ...
                <CardContent className="p-8 relative z-10">
                  ...
                  <p className="text-sm text-muted-foreground mb-6">Essential heart health monitoring</p>
            ...
            >
              <Card className="glass dark:glass-dark border-teal-500 h-full shadow-2xl hover:shadow-3xl hover:shadow-teal-500/30 transition-all duration-500 relative overflow-hidden group">
                ...
                <CardContent className="p-8 relative z-10">
                  ...
                  <p className="text-sm text-muted-foreground mb-6">Advanced AI-powered insights</p>
                  ...
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-teal-500 flex-shrink-0 mt-0.5" />
                      <span className="text-sm">Advanced multi-model AI analysis</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-teal-500 flex-shrink-0 mt-0.5" />
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-teal-500 flex-shrink-0 mt-0.5" />
                      <span className="text-sm">Priority AI assistant support</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-teal-500 flex-shrink-0 mt-0.5" />
            ...
            >
              <Card className="glass dark:glass-dark border-teal-500/20 h-full shadow-xl hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 relative overflow-hidden group">
                ...
                <CardContent className="p-8 relative z-10">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-yellow-500 to-pink-500 flex items-center justify-center shadow-lg">
                      <Brain className="w-6 h-6 text-white" />
                    </div>
                  </div>
                  
                  <h3 className="text-2xl font-black mb-2">Professional</h3>
                  <p className="text-sm text-muted-foreground mb-6">Clinical-grade tools for healthcare providers</p>
                  ...
                  <Button 
                    ...
                    className="w-full bg-gradient-to-r from-yellow-500 to-pink-500 hover:from-yellow-600 hover:to-pink-600 shadow-lg hover:shadow-xl transition-all duration-300"
                    size="lg"
                  >
                    Go Professional
          ...
          <Card className="glass dark:glass-dark border-teal-500/20 overflow-hidden shadow-2xl">
            ...
            <CardContent className="p-12 text-center relative z-10">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join thousands who trust our AI-powered platform for accurate cardiac risk assessment
              </p>
              <Button
                size="lg"
                onClick={() => navigate('/basic-dashboard')}
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              <strong>Medical Disclaimer:</strong> This tool provides AI-powered risk assessments and is not a substitute
