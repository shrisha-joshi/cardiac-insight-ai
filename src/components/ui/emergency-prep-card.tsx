...
import { AlertTriangle, Heart, Phone, Shield, MapPin, Navigation, Hospital, Ambulance, CheckCircle, ExternalLink, X, Settings } from 'lucide-react';
...
export function EmergencyPrepCard() {
  ...
  // Update map URL when radius or location changes
  useEffect(() => {
    if (userLocation) {
      const zoomLevel = Math.max(10, 15 - Math.floor(Math.log2(searchRadius[0])));
      const query = "emergency+care+hospital"; // More specific query
      const mapsUrl = `https://www.google.com/maps/search/${query}/@${userLocation.lat},${userLocation.lng},${zoomLevel}z`;
  ...
  const findNearestHospital = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        // URL will be generated by useEffect based on location and radius
      ...
      (error) => {
        ...
        const fallbackUrl = 'https://www.google.com/maps/search/emergency+care+hospital+near+me';
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-3 px-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-teal-500">{searchRadius[0]} km</span>
              </div>
              <Slider
                value={searchRadius}
              ...
              />
              <p className="text-xs text-muted-foreground">
                Adjust to find hospitals within a wider or narrower area.
              </p>
            </div>
